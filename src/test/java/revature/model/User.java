...
public class User implements Serializable {
	...
	private TestClass testRelation; // if this represents foreign key
	
	public User() {
		super();
	}

	public User(int id, String firstname, String lastname, String emailadress, TestClass testRelation) {
		super();
		this.id = id;
	...
	public TestClass getTestRelation() {
		return testRelation;
	}

	public void setTestRelation(TestClass testRelation) {
		this.testRelation = testRelation;
	}
